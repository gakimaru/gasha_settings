...
#define GASHA_GLOBAL_ALLOCATOR_ENABLE_ASSERTION//メモリ確保／破棄時のアサーションを有効にする場合は、このマクロを有効にする

#define GASHA_GLOBAL_ALLOCATOR_ALLWAYS_TOGETHER_CPP_H//.hファイルのインクルードに伴い、常に.cpp.hファイル（および.inlファイル）を自動インクルードする場合は、このマクロを有効にする
